      ...
      <div className="flex flex-col h-full">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-base font-bold whitespace-nowrap transition-opacity duration-300 ${
        ...
        <div className="p-3 border-t border-slate-100 shrink-0 space-y-3">
          ...
          >
            ...
            <span className={`${isOpen ? "block" : "hidden"} font-black text-xs uppercase tracking-widest`}>
              End Session
            </span>
          </button>
        </div>
