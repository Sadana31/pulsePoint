      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mb-12 space-y-4">
          ...
          <p className="text-lg leading-relaxed text-slate-500">
            It's okay to feel overwhelmed right now. Take a deep breath. 
            Help is just a second away, and we are going to get through this together.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-6 text-left">
          <div className="rounded-3xl border-2 border-slate-100 p-8 transition-all hover:border-red-100">
            <h3 className="text-lg font-bold text-black flex items-center gap-3">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-red-100 text-sm text-red-600">1</span>
              Stay exactly where you are
            </h3>
            <p className="mt-3 text-slate-500">Avoid moving around. Sit or lie down in a comfortable position until help arrives.</p>
          </div>

          <div className="rounded-3xl border-2 border-slate-100 p-8 transition-all hover:border-red-100">
            <h3 className="text-lg font-bold text-black flex items-center gap-3">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-red-100 text-sm text-red-600">2</span>
              Keep your phone nearby
            </h3>
            <p className="mt-3 text-slate-500">Ensure your ringer is on so you can hear incoming calls from emergency responders.</p>
          </div>
        </div>
