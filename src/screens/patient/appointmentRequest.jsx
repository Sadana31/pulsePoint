...
const DOCTORS = [
  "Dr. Anika Rao - General Medicine",
  "Dr. Minh Tran - Cardiology",
  "Dr. Sofia Patel - Dermatology",
  "Dr. Omar Khalid - Orthopedics",
  "Dr. Laila Noor - Pediatrics"
];
...
if (!clashSnapshot.empty) {
  toast.success("This time slot is already booked. Please select another time.");
  return;
}
      ...
      <div className="flex w-full flex-col gap-10 px-20 ">
        ...
        <header className="flex flex-col gap-4 border-b-4 border-[#009999] pb-10">
          ...
          <p className="max-w-xl text-lg font-medium leading-relaxed text-slate-500">
            Share your symptoms and preferred schedule. We’ll prioritize your care and confirm your slot instantly.
          </p>
        </header>
 ...
 <label className="flex flex-col gap-3 text-m font-bold text-black uppercase tracking-wide">
  ...
  {/* SELECT DOCTOR */}
            ...
            <div className="grid gap-5">
              <p className="text-m font-black uppercase tracking-[0.2em] text-[#009999]">Assign Priority</p>
                ...
                {PRIORITIES.map((option) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      <span className={`text-lg font-black ${form.priority === option.id ? "text-[#009999]" : "text-black"}`}>
                        {option.label}
                      </span>
